...
export const config = { matcher: ["/profile/:path*", "/admin/:path*", "/marketplace/:path*", "/messages/:path*", "/notifications/:path*", "/api/account/:path*", "/api/marketplace/:path*", "/api/messages/:path*", "/api/notifications/:path*", "/snake-sorter/:path*", "/api/snake-sorter/:path*"] };
