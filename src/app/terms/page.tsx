...
export default function TermsPage() {
  return <PublicInfoPage
    ...
    sections={[
      ...
      { title: "Arboreal Keeper", paragraphs: ["Arboreal Keeper is a game environment. Virtual animal rarity, virtual prices, genetics abstractions, achievements and progression do not establish biological rarity or real-world market value."] },
