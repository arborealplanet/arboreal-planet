...
export default function TermsPage() {
  return <PublicInfoPage
    ...
    sections={[
      ...
      { title: "Snake Stocks", paragraphs: ["Snake Stocks is market intelligence, not a promise of value, liquidity or a future sale price. Asking prices, observed listings, confirmed sales and estimates are different evidence types and should not be treated as interchangeable."] },
