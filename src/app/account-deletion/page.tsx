  ...
  return <>
    <PublicInfoPage
      ...
      sections={[
        ...
        { title: "Arboreal Keeper and private records", paragraphs: ["Arboreal Keeper progress and private keeper records associated only with the deleted account should not be treated as public biological records. The deletion workflow should remove or detach those records according to the product's current data model."] },
