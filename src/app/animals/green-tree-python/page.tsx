  ...
  return (
    <main>
      <PageIntro
        ...
        aside={<div className="rounded-full border border-emerald-300/15 bg-emerald-300/[.05] px-4 py-2 text-[10px] font-bold uppercase tracking-[.16em] text-emerald-200/65">Published reference species</div>}
      />
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 sm:px-6">
        <div className="grid gap-5 lg:grid-cols-2">
          <div className="panel rounded-3xl p-6"><div className="section-kicker">Origin terminology</div><h2 className="mt-3 text-2xl font-semibold">Simple in public. Detailed underneath.</h2><div className="mt-5 grid gap-3 sm:grid-cols-2"><div className="rounded-2xl border border-emerald-300/10 bg-emerald-300/[.035] p-5"><div className="font-semibold text-emerald-200">Captive Bred</div><p className="mt-2 text-xs leading-5 text-white/34">Includes USCBB, CBB, CB, captive produced and other unambiguous captive-produced terminology.</p></div><div className="rounded-2xl border border-cyan-300/10 bg-cyan-300/[.035] p-5"><div className="font-semibold text-cyan-200">Import</div><p className="mt-2 text-xs leading-5 text-white/34">Includes imported, farm bred, farm raised, ranched, wild caught and LTC, with internal subtype preserved.</p></div></div></div>
          <div className="panel rounded-3xl p-6"><div className="section-kicker">Designer projects</div><h2 className="mt-3 text-2xl font-semibold">Do not force an Import graph where it makes no sense.</h2><p className="mt-4 text-sm leading-6 text-white/38">Designer lines, blue lines, TWBL, calico and other captive project categories are treated as project markets. Their charts should reflect captive-produced evidence rather than inventing an Import comparison.</p><Link href="/snake-stocks" className="mt-6 inline-block text-sm font-bold text-emerald-300">See market structure →</Link></div>
        </div>
      </section>
    </main>
  );
