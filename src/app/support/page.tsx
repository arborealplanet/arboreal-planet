  ...
  return <>
    <PublicInfoPage
      ...
      sections={[
        ...
        { title: "The Hatchery", paragraphs: ["The Hatchery is a virtual educational game area. Virtual animals, values and progression do not modify real pedigree records, Snake Stocks data or real-world marketplace listings."] },
