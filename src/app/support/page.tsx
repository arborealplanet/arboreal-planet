  ...
  return <>
    <PublicInfoPage
      ...
      sections={[
        ...
        { title: "The Hatchery", paragraphs: ["The Hatchery is a virtual educational game area. Virtual animals, values and progression do not modify real pedigree records or real-world marketplace listings."] },
