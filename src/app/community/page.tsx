...
export default async function CommunityPage({searchParams}:{searchParams:Promise<{keeper?:string}>}){const params=await searchParams;const keeper=(params.keeper??"").trim().slice(0,120);return <main>
  ...
  <section className="mx-auto grid max-w-7xl gap-6 px-5 pb-14 sm:px-6 lg:grid-cols-[minmax(0,1.5fr)_minmax(260px,.5fr)]">
    <div className="min-w-0 space-y-4">
      <CommunityComposer/>
      <CommunityFeed initialQuery={keeper}/>
    </div>
