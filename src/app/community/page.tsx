  ...
  <section className="mx-auto grid max-w-7xl gap-6 px-5 pb-14 sm:px-6 lg:grid-cols-[minmax(0,1.5fr)_minmax(260px,.5fr)]">
    ...
    <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
      <div className="panel rounded-[26px] p-5">
        <div className="section-kicker">Browse & follow topics</div>
        <p className="mt-2 text-xs leading-5 text-white/32">Open a topic in Explore or follow it so matching posts can enter your Following feed.</p>
        <div className="mt-4"><CommunityTopicButtons topics={topics}/></div>
        <Link href="/interests" className="mt-4 block text-xs font-bold text-emerald-200/55">Manage all interests →</Link>
      </div>
      <div className="panel-soft rounded-[26px] p-5">
        ...
        <div className="mt-4 grid gap-3 text-xs leading-5 text-white/48">
          ...
          <div>Follow keepers, animals, plants and topics</div>
