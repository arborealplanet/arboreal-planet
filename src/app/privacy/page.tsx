...
export default function PrivacyPage() {
  return <PublicInfoPage
    ...
    sections={[
      ...
      { title: "Market intelligence", paragraphs: ["Snake Stocks is intended to use reviewed market observations and source-aware summaries. Arboreal Planet does not need to publish a user's private pedigree or private collection merely to calculate public market summaries."] },
      { title: "The Hatchery", paragraphs: ["The Hatchery contains virtual game data. Virtual animals, game prices, game rarity and progression records are separate from real pedigree and market records unless a future feature explicitly says otherwise."] },
