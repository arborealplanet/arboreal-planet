...
export default function PrivacyPage() {
  return <PublicInfoPage
    ...
    sections={[
      ...
      { title: "The Hatchery", paragraphs: ["The Hatchery contains virtual game data. Virtual animals, game prices, game rarity and progression records are separate from real pedigree and marketplace records unless a future feature explicitly says otherwise."] },
