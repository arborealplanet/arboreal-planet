...
export default function CommunityGuidelinesPage() {
  return <PublicInfoPage
    ...
    sections={[
      ...
      { title: "Keep real records and game records separate", paragraphs: ["Arboreal Keeper is a virtual game. Do not present virtual animals, game prices, game achievements or game rarity as real marketplace or pedigree evidence."] },
