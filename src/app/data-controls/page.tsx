...
export default function DataControlsPage() {
  return <PublicInfoPage
    ...
    sections={[
      ...
      { title: "The Hatchery", paragraphs: ["The Hatchery stores virtual game progress separately from real pedigree and market records. Virtual animals are not public biological records and are not evidence about real animals."] },
