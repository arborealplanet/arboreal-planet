        ...
        {!analysisResult ? (
          ...
          <div className="mt-5 grid gap-5 xl:grid-cols-[.9fr_1.1fr]">
            ...
            <div className="space-y-4">
              ...
              {canViewReferenceMedia && analysisResult.nearestReferences.length > 0 && (
                <div className="rounded-[24px] border border-white/[.06] bg-black/[.06] p-4">
          ...
          <div className="mt-5 rounded-[24px] border border-emerald-300/10 bg-emerald-300/[.02] p-4">
            ...
            {promotionOpen && (
              <form onSubmit={(event) => void promoteScanToReference(event)} className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <label className="text-[9px] font-black uppercase tracking-[.08em] text-white/28">Challenge expectation
                  <select name="challenge_expectation" defaultValue="review" className={`${field} mt-2`}>
                    <option value="reject">Reject / Unknown</option><option value="classify">Classify trusted hard case</option><option value="review">Review only / diagnostic</option>
                  </select>
                </label>
