  ...
  useEffect(() => {
    ...
    async function repair() {
      try {
        ...
        // Leave an unreadable local save alone; the cloud recovery path can still restore it.
      }
      ...
      try {
        ...
        // Continue into the game even if the cloud repair endpoint is temporarily unavailable.
      } finally {
