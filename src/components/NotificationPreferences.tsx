...
const options:[keyof Preferences,string,string][]=[
  ...
  ["followed_subject_updates","Followed-interest activity","Optional alerts when new Community activity matches animals, plants or topics you follow. Throttled to at most one alert every 12 hours."],
];
